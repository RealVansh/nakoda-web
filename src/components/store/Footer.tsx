        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/products" className="text-sm text-muted-foreground hover:text-primary transition-colors">All Collections</Link></li>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-sm font-semibold text-foreground tracking-wider uppercase mb-6">Visit Us</h3>
            <ul className="space-y-4">
